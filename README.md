...
*Limitations: Unmapped objects or complex effects not represented in the mapping file will be logged as warnings, allowing AviUtl2 to ingest the file without structural crashes.*
If your legacy .aup project is using default scene names (i.e Root, Scene 1, Scene 2, etc.), scene detection may not work. In that case, rename the scenes before exporting to the exo format.
